    ...
    <div className='container mx-auto p-2'>
        <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
            <div className='w-full h-full rounded-xl p-20 backdrop-brightness-50'>
                ...
                <p className='text-white text-center pb-4 font-bold'>Use this URL shortener to create a shortened & neat link</p>
                <form onSubmit={handleSubmit}>
                    <div className='flex'>
                        <div className='relative w-full'>
                            ...
                            required 
                            className='block w-full p-4 ps-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500' 
                            value={fullUrl}
